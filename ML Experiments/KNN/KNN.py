"""
Runs a K-nearest neighbor algorithm using our cipher data from ../../Data in order to classify
a ciphertext to belong to a particular cipher. Uses sklearn KNeighborsClassifier.
